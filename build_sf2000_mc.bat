...
REM Uses: sf2000_multicore_official (madcock)
REM ========================================
...
copy /Y "%MULTICORE_DIR%\cores\uae4all092\Makefile" "%MULTICORE_DIR%\cores\%CORE_NAME%\" 2>nul
...
echo.
echo ========================================
echo BUILD SUCCESSFUL! (SF2000 Multicore Official)
echo ========================================
echo.
