...
extern void disk_insert_multidisk (const char *name); /* v022: multi-disk auto-detection */
/* v055: Disk shuffler system */
extern void disk_shuffle (void);
extern const char* disk_get_name (int drive, char* buf, int max_len);
extern int disk_get_multidisk_count (void);
