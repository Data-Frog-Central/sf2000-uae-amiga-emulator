...
copy /Y "%MULTICORE_DIR%\linker_scripts\bisrv_08_03-core.ld" "%UAE_DIR%" >nul 2>nul
...
echo.
echo [6/7] Linking core_87000000 (SF2000 FrogUI)...
wsl -e bash -c "cd '%WSL_MULTICORE%' && export PATH=/opt/mips32-mti-elf/2019.09-03-2/bin:/tmp/mips32-mti-elf/2019.09-03-2/bin:$PATH && rm -f core_87000000 core.elf libretro_core.a 2>/dev/null; make CORE=cores/uae4all152 CONSOLE=amiga FROGGY_TYPE=SF2000 core_87000000"
...
copy /Y "%MULTICORE_DIR%\core_87000000" "%UAE_DIR%core_87000000_sf2000_frogui"
...
echo.
echo Output: %UAE_DIR%core_87000000_sf2000_frogui
for %%A in ("%UAE_DIR%core_87000000_sf2000_frogui") do echo Size: %%~zA bytes
echo.
